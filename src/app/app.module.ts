...
import {RouterModule, Routes} from '@angular/router'; // importar rotas para usar o appRoutes
...
const  appRoutes: Routes = [
  {path: '', pathMatch: 'full', component: PostListComponent}, // pathmatch: full
...
@NgModule({
  ...
  imports: [
    ...
    HttpClientModule,
    FormsModule // para disponibliziar o twowy-binding / formularios
  ],
  // importar serviços
  providers: [
      PostService,
